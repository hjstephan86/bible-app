...
public class AmericanStandardVersion extends Bible {

	public AmericanStandardVersion(String name) throws IOException {
		this.name = name;
		readBible();
		readIgnore();
	...
	public void readBible() throws IOException {
		...
		try (InputStream inputStream = getClass().getResourceAsStream("/bible/AmericanStandardVersion.txt");
