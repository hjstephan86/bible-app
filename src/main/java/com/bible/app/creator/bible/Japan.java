...
public class Japan extends Bible {

    public Japan(String name) throws IOException {
        this.name = name;
        readBible();
        readIgnore();
    ...
    public void readBible() throws IOException {
        ...
        try (InputStream inputStream = getClass().getResourceAsStream("/bible/Bungo.txt");
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (!bookMap.get(book).getChapter().get(chapter).getVerses().containsKey(verseNumber)) {
                    ...
                    verseText = "<span class=\"japan\">" + verseText + "</span>";
    ...
    public void readIgnore() throws IOException {
        ...
        try (InputStream inputStream = getClass().getResourceAsStream("/ignore/ignore-Ja.txt");
                BufferedReader br = new BufferedReader(new InputStreamReader(inputStream))) {
            String line;
            while ((line = br.readLine()) != null) {
