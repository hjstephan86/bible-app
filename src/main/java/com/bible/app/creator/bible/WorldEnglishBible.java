...
public class WorldEnglishBible extends Bible {

	public WorldEnglishBible(String name) throws IOException {
		this.name = name;
		readBible();
		readIgnore();
	...
	public void readBible() throws IOException {
		...
		try (InputStream inputStream = getClass().getResourceAsStream("/bible/WorldEnglishBible.txt");
