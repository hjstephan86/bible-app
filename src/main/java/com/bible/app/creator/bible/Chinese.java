...
public class Chinese extends Bible {

    public Chinese(String name) throws IOException {
        this.name = name;
        readBible();
        readIgnore();
    ...
    public void readBible() throws IOException {
        ...
        try (InputStream inputStream = getClass().getResourceAsStream("/bible/Chinese-Union.txt");
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (!bookMap.get(book).getChapter().get(chapter).getVerses().containsKey(verseNumber)) {
                    ...
                    // Add span for chinese formatting
                    verseText = "<span class=\"chinese\">" + verseText + "</span>";
    ...
    public void readIgnore() throws IOException {
        ...
        try (InputStream inputStream = getClass().getResourceAsStream("/ignore/ignore-Zh.txt");
                BufferedReader br = new BufferedReader(new InputStreamReader(inputStream))) {
            String line;
            while ((line = br.readLine()) != null) {
