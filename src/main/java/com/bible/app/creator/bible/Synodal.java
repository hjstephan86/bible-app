...
public class Synodal extends Bible {

    public Synodal(String name) throws IOException {
        this.name = name;
        readBible();
        readIgnore();
    ...
    public void readBible() throws IOException {
        ...
        try (InputStream inputStream = getClass().getResourceAsStream("/bible/Synodal.txt");
    ...
    public void readIgnore() throws IOException {
        ...
        try (InputStream inputStream = getClass().getResourceAsStream("/ignore/ignore-Ru.txt");
                BufferedReader br = new BufferedReader(new InputStreamReader(inputStream))) {
            String line;
            while ((line = br.readLine()) != null) {
